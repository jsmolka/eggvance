...
{
    { "AWRE", Save::Type::Flash64 , Gpio::Type::None, false },  // Advance Wars
    { "AWRP", Save::Type::Flash64 , Gpio::Type::None, false },  // Advance Wars
    { "AW2E", Save::Type::Flash64 , Gpio::Type::None, false },  // Advance Wars 2: Black Hole Rising
    { "AW2P", Save::Type::Flash64 , Gpio::Type::None, false },  // Advance Wars 2: Black Hole Rising
    ...
    { "PEAJ", Save::Type::Flash128, Gpio::Type::None, false },  // e-Reader
    { "PSAJ", Save::Type::Flash128, Gpio::Type::None, false },  // e-Reader
    { "PSAE", Save::Type::Flash128, Gpio::Type::None, false },  // e-Reader
    ...
    { "BLVJ", Save::Type::Flash64 , Gpio::Type::Rtc , false },  // Legendz - Sign of Nekuromu
    ...
    { "AXVJ", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Ruby
    { "AXVE", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Ruby
    { "AXVP", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Ruby
    { "AXVI", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Ruby
    { "AXVS", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Ruby
    { "AXVD", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Ruby
    { "AXVF", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Ruby
    { "AXPJ", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Sapphire
    { "AXPE", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Sapphire
    { "AXPP", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Sapphire
    { "AXPI", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Sapphire
    { "AXPS", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Sapphire
    { "AXPD", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Sapphire
    { "AXPF", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Sapphire
    { "BPEJ", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Emerald
    { "BPEE", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Emerald
    { "BPEP", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Emerald
    { "BPEI", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Emerald
    { "BPES", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Emerald
    { "BPED", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Emerald
    { "BPEF", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Pokemon Emerald
    { "B24J", Save::Type::Flash128, Gpio::Type::None, false },  // Pokemon Mystery Dungeon
    { "B24E", Save::Type::Flash128, Gpio::Type::None, false },  // Pokemon Mystery Dungeon
    { "B24P", Save::Type::Flash128, Gpio::Type::None, false },  // Pokemon Mystery Dungeon
    { "B24U", Save::Type::Flash128, Gpio::Type::None, false },  // Pokemon Mystery Dungeon
    { "BPRJ", Save::Type::Flash128, Gpio::Type::None, false },  // Pokemon FireRed
    { "BPRE", Save::Type::Flash128, Gpio::Type::None, false },  // Pokemon FireRed
    { "BPRP", Save::Type::Flash128, Gpio::Type::None, false },  // Pokemon FireRed
    { "BPRI", Save::Type::Flash128, Gpio::Type::None, false },  // Pokemon FireRed
    { "BPRS", Save::Type::Flash128, Gpio::Type::None, false },  // Pokemon FireRed
    { "BPRD", Save::Type::Flash128, Gpio::Type::None, false },  // Pokemon FireRed
    { "BPRF", Save::Type::Flash128, Gpio::Type::None, false },  // Pokemon FireRed
    { "BPGJ", Save::Type::Flash128, Gpio::Type::None, false },  // Pokemon LeafGreen
    { "BPGE", Save::Type::Flash128, Gpio::Type::None, false },  // Pokemon LeafGreen
    { "BPGP", Save::Type::Flash128, Gpio::Type::None, false },  // Pokemon LeafGreen
    { "BPGI", Save::Type::Flash128, Gpio::Type::None, false },  // Pokemon LeafGreen
    { "BPGS", Save::Type::Flash128, Gpio::Type::None, false },  // Pokemon LeafGreen
    { "BPGD", Save::Type::Flash128, Gpio::Type::None, false },  // Pokemon LeafGreen
    { "BPGF", Save::Type::Flash128, Gpio::Type::None, false },  // Pokemon LeafGreen
    { "BR4J", Save::Type::Flash64 , Gpio::Type::Rtc , false },  // RockMan EXE 4.5 - Real Operation
    { "AR8E", Save::Type::Eeprom  , Gpio::Type::None, false },  // Rocky
    { "AROP", Save::Type::Eeprom  , Gpio::Type::None, false },  // Rocky
    { "BKAJ", Save::Type::Flash128, Gpio::Type::Rtc , false },  // Sennen Kazoku
    ...
    { "AX4J", Save::Type::Flash128, Gpio::Type::None, false },  // Super Mario Advance 4
    { "AX4E", Save::Type::Flash128, Gpio::Type::None, false },  // Super Mario Advance 4
