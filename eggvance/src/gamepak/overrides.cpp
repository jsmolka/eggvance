...
const std::vector<GamePak::Override> GamePak::overrides =
{
    ...
    { "AW2E", Save::Type::Flash64 , Gpio::Type::None },  // Advance Wars 2: Black Hole Rising
    { "AW2P", Save::Type::Flash64 , Gpio::Type::None },  // Advance Wars 2: Black Hole Rising
    ...
    { "PEAJ", Save::Type::Flash128, Gpio::Type::None },  // e-Reader
    { "PSAJ", Save::Type::Flash128, Gpio::Type::None },  // e-Reader
    { "PSAE", Save::Type::Flash128, Gpio::Type::None },  // e-Reader
    ...
    { "AFXE", Save::Type::Flash64 , Gpio::Type::None },  // Final Fantasy Tactics Advance
    { "BFTJ", Save::Type::Flash128, Gpio::Type::None },  // F-Zero - Climax
    { "AGFE", Save::Type::Flash64 , Gpio::Type::None },  // Golden Sun: The Lost Age
    ...
    { "BLJJ", Save::Type::Flash64 , Gpio::Type::Rtc  },  // Legendz - Yomigaeru Shiren no Shima
    { "BLJK", Save::Type::Flash64 , Gpio::Type::Rtc  },  // Legendz - Yomigaeru Shiren no Shima KOR
    { "BLVJ", Save::Type::Flash64 , Gpio::Type::Rtc  },  // Legendz - Sign of Nekuromu
    ...
    { "AXVJ", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Ruby
    { "AXVE", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Ruby
    { "AXVP", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Ruby
    { "AXVI", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Ruby
    { "AXVS", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Ruby
    { "AXVD", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Ruby
    { "AXVF", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Ruby
    { "AXPJ", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Sapphire
    { "AXPE", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Sapphire
    { "AXPP", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Sapphire
    { "AXPI", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Sapphire
    { "AXPS", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Sapphire
    { "AXPD", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Sapphire
    { "AXPF", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Sapphire
    { "BPEJ", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Emerald
    { "BPEE", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Emerald
    { "BPEP", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Emerald
    { "BPEI", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Emerald
    { "BPES", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Emerald
    { "BPED", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Emerald
    { "BPEF", Save::Type::Flash128, Gpio::Type::Rtc  },  // Pokemon Emerald
    { "B24J", Save::Type::Flash128, Gpio::Type::None },  // Pokemon Mystery Dungeon
    { "B24E", Save::Type::Flash128, Gpio::Type::None },  // Pokemon Mystery Dungeon
    { "B24P", Save::Type::Flash128, Gpio::Type::None },  // Pokemon Mystery Dungeon
    { "B24U", Save::Type::Flash128, Gpio::Type::None },  // Pokemon Mystery Dungeon
    { "BPRJ", Save::Type::Flash128, Gpio::Type::None },  // Pokemon FireRed
    { "BPRE", Save::Type::Flash128, Gpio::Type::None },  // Pokemon FireRed
    { "BPRP", Save::Type::Flash128, Gpio::Type::None },  // Pokemon FireRed
    { "BPRI", Save::Type::Flash128, Gpio::Type::None },  // Pokemon FireRed
    { "BPRS", Save::Type::Flash128, Gpio::Type::None },  // Pokemon FireRed
    { "BPRD", Save::Type::Flash128, Gpio::Type::None },  // Pokemon FireRed
    { "BPRF", Save::Type::Flash128, Gpio::Type::None },  // Pokemon FireRed
    { "BPGJ", Save::Type::Flash128, Gpio::Type::None },  // Pokemon LeafGreen
    { "BPGE", Save::Type::Flash128, Gpio::Type::None },  // Pokemon LeafGreen
    { "BPGP", Save::Type::Flash128, Gpio::Type::None },  // Pokemon LeafGreen
    { "BPGI", Save::Type::Flash128, Gpio::Type::None },  // Pokemon LeafGreen
    { "BPGS", Save::Type::Flash128, Gpio::Type::None },  // Pokemon LeafGreen
    { "BPGD", Save::Type::Flash128, Gpio::Type::None },  // Pokemon LeafGreen
    { "BPGF", Save::Type::Flash128, Gpio::Type::None },  // Pokemon LeafGreen
    { "BR4J", Save::Type::Flash64 , Gpio::Type::Rtc  },  // RockMan EXE 4.5 - Real Operation
    { "AR8E", Save::Type::Eeprom  , Gpio::Type::None },  // Rocky
    { "AROP", Save::Type::Eeprom  , Gpio::Type::None },  // Rocky
    { "BKAJ", Save::Type::Flash128, Gpio::Type::Rtc  },  // Sennen Kazoku
    ...
    { "AX4J", Save::Type::Flash128, Gpio::Type::None },  // Super Mario Advance 4
    { "AX4E", Save::Type::Flash128, Gpio::Type::None },  // Super Mario Advance 4
    { "AX4P", Save::Type::Flash128, Gpio::Type::None },  // Super Mario Advance 4
