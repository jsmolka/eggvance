...
void IO::writeByte(u32 addr, u8 byte)
{
    ...
    WRITE_HALF_REG(REG_BG3CNT,   ppu.io.bgcnt[3]);
    WRITE_HALF_REG(REG_BG0HOFS,  ppu.io.bghofs[0]);
    WRITE_HALF_REG(REG_BG0VOFS,  ppu.io.bgvofs[0]);
    WRITE_HALF_REG(REG_BG1HOFS,  ppu.io.bghofs[1]);
    WRITE_HALF_REG(REG_BG1VOFS,  ppu.io.bgvofs[1]);
    WRITE_HALF_REG(REG_BG2HOFS,  ppu.io.bghofs[2]);
    WRITE_HALF_REG(REG_BG2VOFS,  ppu.io.bgvofs[2]);
    WRITE_HALF_REG(REG_BG3HOFS,  ppu.io.bghofs[3]);
    WRITE_HALF_REG(REG_BG3VOFS,  ppu.io.bgvofs[3]);
    WRITE_HALF_REG(REG_BG2PA,    ppu.io.bgpa[0]);
    WRITE_HALF_REG(REG_BG2PB,    ppu.io.bgpb[0]);
    WRITE_HALF_REG(REG_BG2PC,    ppu.io.bgpc[0]);
    WRITE_HALF_REG(REG_BG2PD,    ppu.io.bgpd[0]);
    WRITE_HALF_REG(REG_BG3PA,    ppu.io.bgpa[1]);
    WRITE_HALF_REG(REG_BG3PB,    ppu.io.bgpb[1]);
    WRITE_HALF_REG(REG_BG3PC,    ppu.io.bgpc[1]);
    WRITE_HALF_REG(REG_BG3PD,    ppu.io.bgpd[1]);
    WRITE_WORD_REG(REG_BG2X,     ppu.io.bgx[0]);
    WRITE_WORD_REG(REG_BG2Y,     ppu.io.bgy[0]);
    WRITE_WORD_REG(REG_BG3X,     ppu.io.bgx[1]);
    WRITE_WORD_REG(REG_BG3Y,     ppu.io.bgy[1]);
    WRITE_HALF_REG(REG_WIN0H,    ppu.io.winh[0]);
    WRITE_HALF_REG(REG_WIN0V,    ppu.io.winv[0]);
    WRITE_HALF_REG(REG_WIN1H,    ppu.io.winh[1]);
    WRITE_HALF_REG(REG_WIN1V,    ppu.io.winv[1]);
    WRITE_HALF_REG(REG_WININ,    ppu.io.winin);
    WRITE_HALF_REG(REG_WINOUT,   ppu.io.winout);
