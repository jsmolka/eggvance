...
public:
    ...
    BitField<u16,  4, 1> a_obj;  // Top layer OBJ
    BitField<u16,  5, 1> a_bdp;  // Top layer backdrop
    ...
    BitField<u16, 12, 1> b_obj;  // Bottom layer OBJ
    BitField<u16, 13, 1> b_bdp;  // Bottom layer backdrop
