...
public:
    ...
    BitField<u16,  4, 1> a_sprites;   // Top layer sprites
    BitField<u16,  5, 1> a_backdrop;  // Top layer backdrop
    ...
    BitField<u16, 12, 1> b_sprites;   // Bottom layer sprites
    BitField<u16, 13, 1> b_backdrop;  // Bottom layer backdrop

    int a_bg(int bg) const;
    int b_bg(int bg) const;
};
