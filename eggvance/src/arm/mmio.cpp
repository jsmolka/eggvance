...
u8 Arm::readIo(u32 addr)
{
    ...
    INDEXED_CASE2(kRegSound1ControlL, return apu.sequencer.square1.readL<kIndex>());
    INDEXED_CASE2(kRegSound1ControlH, return apu.sequencer.square1.readH<kIndex>());
    INDEXED_CASE2(kRegSound1ControlX, return apu.sequencer.square1.readX<kIndex>());
    INDEXED_CASE2(kRegUnused066,      return 0);
    INDEXED_CASE2(kRegSound2ControlL, return apu.sequencer.square2.readL<kIndex>());
    INDEXED_CASE2(kRegSound2ControlX, return apu.sequencer.square2.readX<kIndex>());
    ...
    INDEXED_CASE2(kRegSound4ControlL, return apu.sequencer.noise.readL<kIndex>());
    INDEXED_CASE2(kRegUnused07A,      return 0);
    INDEXED_CASE2(kRegSound4ControlX, return apu.sequencer.noise.readX<kIndex>());
    INDEXED_CASE2(kRegUnused07E,      return 0);
    INDEXED_CASE2(kRegSoundControlL,  return apu.psg_sound.read<kIndex>());
    INDEXED_CASE2(kRegSoundControlH,  return apu.direct_sound.read<kIndex>());
    INDEXED_CASE2(kRegSoundControlX,  return apu.sound_enable.read<kIndex>());
    INDEXED_CASE2(kRegUnused086,      return 0);
    INDEXED_CASE2(kRegSoundBias,      return apu.sound_bias.read<kIndex>());
    INDEXED_CASE2(kRegUnused08A,      return 0);
    INDEXED_CASE2(kRegWaveRam0,       return apu.sequencer.wave.readBank( 0 + kIndex));
    INDEXED_CASE2(kRegWaveRam1,       return apu.sequencer.wave.readBank( 2 + kIndex));
    INDEXED_CASE2(kRegWaveRam2,       return apu.sequencer.wave.readBank( 4 + kIndex));
    INDEXED_CASE2(kRegWaveRam3,       return apu.sequencer.wave.readBank( 6 + kIndex));
    INDEXED_CASE2(kRegWaveRam4,       return apu.sequencer.wave.readBank( 8 + kIndex));
    INDEXED_CASE2(kRegWaveRam5,       return apu.sequencer.wave.readBank(10 + kIndex));
    INDEXED_CASE2(kRegWaveRam6,       return apu.sequencer.wave.readBank(12 + kIndex));
    INDEXED_CASE2(kRegWaveRam7,       return apu.sequencer.wave.readBank(14 + kIndex));
...
void Arm::writeIo(u32 addr, u8 byte)
{
    ...
    INDEXED_CASE2(kRegSound1ControlL, apu.sequencer.square1.writeL<kIndex>(byte));
    INDEXED_CASE2(kRegSound1ControlH, apu.sequencer.square1.writeH<kIndex>(byte));
    INDEXED_CASE2(kRegSound1ControlX, apu.sequencer.square1.writeX<kIndex>(byte));
    INDEXED_CASE2(kRegSound2ControlL, apu.sequencer.square2.writeL<kIndex>(byte));
    INDEXED_CASE2(kRegSound2ControlX, apu.sequencer.square2.writeX<kIndex>(byte));
    ...
    INDEXED_CASE2(kRegSound4ControlL, apu.sequencer.noise.writeL<kIndex>(byte));
    INDEXED_CASE2(kRegSound4ControlX, apu.sequencer.noise.writeX<kIndex>(byte));
    INDEXED_CASE2(kRegSoundControlL,  apu.psg_sound.write<kIndex>(byte));
    INDEXED_CASE2(kRegSoundControlH,  apu.direct_sound.write<kIndex>(byte));
    INDEXED_CASE2(kRegSoundControlX,  apu.sound_enable.write<kIndex>(byte));
    INDEXED_CASE2(kRegSoundBias,      apu.sound_bias.write<kIndex>(byte));
    INDEXED_CASE2(kRegWaveRam0,       return apu.sequencer.wave.writeBank( 0 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam1,       return apu.sequencer.wave.writeBank( 2 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam2,       return apu.sequencer.wave.writeBank( 4 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam3,       return apu.sequencer.wave.writeBank( 6 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam4,       return apu.sequencer.wave.writeBank( 8 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam5,       return apu.sequencer.wave.writeBank(10 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam6,       return apu.sequencer.wave.writeBank(12 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam7,       return apu.sequencer.wave.writeBank(14 + kIndex, byte));
