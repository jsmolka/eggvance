...
void Arm::writeIo(u32 addr, u8 byte)
{
    ...
    SHELL_CASE02(uint(Io::Bg2ParameterA),  ppu.bgpa[0].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg2ParameterB),  ppu.bgpb[0].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg2ParameterC),  ppu.bgpc[0].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg2ParameterD),  ppu.bgpd[0].write(kIndex, byte));
    SHELL_CASE04(uint(Io::Bg2ReferenceX),  ppu.bgx[0].write(kIndex, byte));
    SHELL_CASE04(uint(Io::Bg2ReferenceY),  ppu.bgy[0].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg3ParameterA),  ppu.bgpa[1].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg3ParameterB),  ppu.bgpb[1].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg3ParameterC),  ppu.bgpc[1].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg3ParameterD),  ppu.bgpd[1].write(kIndex, byte));
    SHELL_CASE04(uint(Io::Bg3ReferenceX),  ppu.bgx[1].write(kIndex, byte));
    SHELL_CASE04(uint(Io::Bg3ReferenceY),  ppu.bgy[1].write(kIndex, byte));
