...
u8 Arm::readIo(u32 addr)
{
    ...
    SHELL_CASE02(uint(Io::Bg0Control),     return ppu.bgcnt[0].read(kIndex));
    SHELL_CASE02(uint(Io::Bg1Control),     return ppu.bgcnt[1].read(kIndex));
    SHELL_CASE02(uint(Io::Bg2Control),     return ppu.bgcnt[2].read(kIndex));
    SHELL_CASE02(uint(Io::Bg3Control),     return ppu.bgcnt[3].read(kIndex));
...
void Arm::writeIo(u32 addr, u8 byte)
{
    ...
    SHELL_CASE02(uint(Io::Bg0Control),     ppu.bgcnt[0].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg1Control),     ppu.bgcnt[1].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg2Control),     ppu.bgcnt[2].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg3Control),     ppu.bgcnt[3].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg0HorOffset),   ppu.bghofs[0].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg0VerOffset),   ppu.bgvofs[0].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg1HorOffset),   ppu.bghofs[1].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg1VerOffset),   ppu.bgvofs[1].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg2HorOffset),   ppu.bghofs[2].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg2VerOffset),   ppu.bgvofs[2].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg3HorOffset),   ppu.bghofs[3].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg3VerOffset),   ppu.bgvofs[3].write(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg2ParameterA),  ppu.matrix[0].writeA(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg2ParameterB),  ppu.matrix[0].writeB(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg2ParameterC),  ppu.matrix[0].writeC(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg2ParameterD),  ppu.matrix[0].writeD(kIndex, byte));
    SHELL_CASE04(uint(Io::Bg2ReferenceX),  ppu.matrix[0].writeX(kIndex, byte));
    SHELL_CASE04(uint(Io::Bg2ReferenceY),  ppu.matrix[0].writeY(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg3ParameterA),  ppu.matrix[1].writeA(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg3ParameterB),  ppu.matrix[1].writeB(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg3ParameterC),  ppu.matrix[1].writeC(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg3ParameterD),  ppu.matrix[1].writeD(kIndex, byte));
    SHELL_CASE04(uint(Io::Bg3ReferenceX),  ppu.matrix[1].writeX(kIndex, byte));
    SHELL_CASE04(uint(Io::Bg3ReferenceY),  ppu.matrix[1].writeY(kIndex, byte));
