...
u8 Arm::readIo(u32 addr)
{
    ...
    INDEXED_CASE2(kRegWaveRam0,       return apu.sequencer.wave.readRam( 0 + kIndex));
    INDEXED_CASE2(kRegWaveRam1,       return apu.sequencer.wave.readRam( 2 + kIndex));
    INDEXED_CASE2(kRegWaveRam2,       return apu.sequencer.wave.readRam( 4 + kIndex));
    INDEXED_CASE2(kRegWaveRam3,       return apu.sequencer.wave.readRam( 6 + kIndex));
    INDEXED_CASE2(kRegWaveRam4,       return apu.sequencer.wave.readRam( 8 + kIndex));
    INDEXED_CASE2(kRegWaveRam5,       return apu.sequencer.wave.readRam(10 + kIndex));
    INDEXED_CASE2(kRegWaveRam6,       return apu.sequencer.wave.readRam(12 + kIndex));
    INDEXED_CASE2(kRegWaveRam7,       return apu.sequencer.wave.readRam(14 + kIndex));
...
void Arm::writeIo(u32 addr, u8 byte)
{
    ...
    INDEXED_CASE2(kRegWaveRam0,       return apu.sequencer.wave.writeRam( 0 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam1,       return apu.sequencer.wave.writeRam( 2 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam2,       return apu.sequencer.wave.writeRam( 4 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam3,       return apu.sequencer.wave.writeRam( 6 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam4,       return apu.sequencer.wave.writeRam( 8 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam5,       return apu.sequencer.wave.writeRam(10 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam6,       return apu.sequencer.wave.writeRam(12 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam7,       return apu.sequencer.wave.writeRam(14 + kIndex, byte));
