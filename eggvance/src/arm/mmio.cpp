...
void Arm::writeIo(u32 addr, u8 byte)
{
    ...
    INDEXED_CASE2(kRegWaveRam0,       apu.sequencer.wave.writeRam( 0 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam1,       apu.sequencer.wave.writeRam( 2 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam2,       apu.sequencer.wave.writeRam( 4 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam3,       apu.sequencer.wave.writeRam( 6 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam4,       apu.sequencer.wave.writeRam( 8 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam5,       apu.sequencer.wave.writeRam(10 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam6,       apu.sequencer.wave.writeRam(12 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam7,       apu.sequencer.wave.writeRam(14 + kIndex, byte));
