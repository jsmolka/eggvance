...
void Arm::writeIo(u32 addr, u8 byte)
{
    ...
    INDEXED_CASE4(kRegDma0Sad,        dma.channels[0].sad.write(kIndex, byte));
    INDEXED_CASE4(kRegDma0Dad,        dma.channels[0].dad.write(kIndex, byte));
    INDEXED_CASE2(kRegDma0Count,      dma.channels[0].count.write(kIndex, byte));
    INDEXED_CASE2(kRegDma0Control,    dma.channels[0].control.write(kIndex, byte));
    INDEXED_CASE4(kRegDma1Sad,        dma.channels[1].sad.write(kIndex, byte));
    INDEXED_CASE4(kRegDma1Dad,        dma.channels[1].dad.write(kIndex, byte));
    INDEXED_CASE2(kRegDma1Count,      dma.channels[1].count.write(kIndex, byte));
    INDEXED_CASE2(kRegDma1Control,    dma.channels[1].control.write(kIndex, byte));
    INDEXED_CASE4(kRegDma2Sad,        dma.channels[2].sad.write(kIndex, byte));
    INDEXED_CASE4(kRegDma2Dad,        dma.channels[2].dad.write(kIndex, byte));
    INDEXED_CASE2(kRegDma2Count,      dma.channels[2].count.write(kIndex, byte));
    INDEXED_CASE2(kRegDma2Control,    dma.channels[2].control.write(kIndex, byte));
    INDEXED_CASE4(kRegDma3Sad,        dma.channels[3].sad.write(kIndex, byte));
    INDEXED_CASE4(kRegDma3Dad,        dma.channels[3].dad.write(kIndex, byte));
    INDEXED_CASE2(kRegDma3Count,      dma.channels[3].count.write(kIndex, byte));
    INDEXED_CASE2(kRegDma3Control,    dma.channels[3].control.write(kIndex, byte));
