...
u8 Arm::readIo(u32 addr)
{
    ...
    INDEXED_CASE8(kRegSound1ControlL, return apu.sequencer.square1.read(kIndex));
    INDEXED_CASE8(kRegSound2ControlL, return apu.sequencer.square2.read(kIndex));
    INDEXED_CASE8(kRegSound3ControlL, return apu.sequencer.wave.read(kIndex));
    INDEXED_CASE8(kRegSound4ControlL, return apu.sequencer.noise.read(kIndex));
    ...
    INDEXED_CASE2(kRegWaveRam0,       return apu.sequencer.wave.ram.read( 0 + kIndex));
    INDEXED_CASE2(kRegWaveRam1,       return apu.sequencer.wave.ram.read( 2 + kIndex));
    INDEXED_CASE2(kRegWaveRam2,       return apu.sequencer.wave.ram.read( 4 + kIndex));
    INDEXED_CASE2(kRegWaveRam3,       return apu.sequencer.wave.ram.read( 6 + kIndex));
    INDEXED_CASE2(kRegWaveRam4,       return apu.sequencer.wave.ram.read( 8 + kIndex));
    INDEXED_CASE2(kRegWaveRam5,       return apu.sequencer.wave.ram.read(10 + kIndex));
    INDEXED_CASE2(kRegWaveRam6,       return apu.sequencer.wave.ram.read(12 + kIndex));
    INDEXED_CASE2(kRegWaveRam7,       return apu.sequencer.wave.ram.read(14 + kIndex));
...
void Arm::writeIo(u32 addr, u8 byte)
{
    ...
    INDEXED_CASE8(kRegSound1ControlL, apu.sequencer.square1.write(kIndex, byte));
    INDEXED_CASE8(kRegSound2ControlL, apu.sequencer.square2.write(kIndex, byte));
    INDEXED_CASE8(kRegSound3ControlL, apu.sequencer.wave.write(kIndex, byte));
    INDEXED_CASE8(kRegSound4ControlL, apu.sequencer.noise.write(kIndex, byte));
    ...
    INDEXED_CASE2(kRegWaveRam0,       apu.sequencer.wave.ram.write( 0 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam1,       apu.sequencer.wave.ram.write( 2 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam2,       apu.sequencer.wave.ram.write( 4 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam3,       apu.sequencer.wave.ram.write( 6 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam4,       apu.sequencer.wave.ram.write( 8 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam5,       apu.sequencer.wave.ram.write(10 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam6,       apu.sequencer.wave.ram.write(12 + kIndex, byte));
    INDEXED_CASE2(kRegWaveRam7,       apu.sequencer.wave.ram.write(14 + kIndex, byte));
