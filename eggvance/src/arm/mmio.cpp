...
void Arm::writeIo(u32 addr, u8 byte)
{
    ...
    SHELL_CASE02(uint(Io::Bg0HorOffset),   ppu.backgrounds[0].origin.writeX(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg0VerOffset),   ppu.backgrounds[0].origin.writeY(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg1HorOffset),   ppu.backgrounds[1].origin.writeX(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg1VerOffset),   ppu.backgrounds[1].origin.writeY(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg2HorOffset),   ppu.backgrounds[2].origin.writeX(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg2VerOffset),   ppu.backgrounds[2].origin.writeY(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg3HorOffset),   ppu.backgrounds[3].origin.writeX(kIndex, byte));
    SHELL_CASE02(uint(Io::Bg3VerOffset),   ppu.backgrounds[3].origin.writeY(kIndex, byte));
