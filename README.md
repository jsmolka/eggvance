...
## Progress
This list contains dates for some of the early emulator progress.
...
## Commercial Games
The emulator supports around half of the commerical games available with minor or major issues. A full compatibility list will be provided once the emulator reaches a more mature state.
